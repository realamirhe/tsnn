...
streams = (
    ["".join(permutation) for permutation in itertools.permutations(language, 1)]
    + ["".join(permutation) for permutation in itertools.permutations(language, 2)]
    + ["".join(permutation) for permutation in itertools.permutations(language, 3)]
    + ["".join(permutation) for permutation in itertools.permutations(language, 4)]
)
