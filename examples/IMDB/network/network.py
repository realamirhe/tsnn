...
from examples.IMDB.config import words_max_delay, population_size, average_words_length
...
from src.core.learning.stdp import SynapsePairWiseSTDP, SynapsePairWiseSTDPWithoutDelay
...
from src.core.stabilizer.pop_activity import PopulationBaseActivity
from src.core.stabilizer.pop_homeostasis import PopulationBaseHomeostasis
from src.helpers.network import EpisodeTracker

"""
WIP: Check the correct path for synapse_lens_selector

TODO: Check the ceiling effect on homeostasis behaviour (PopHomeostasis)
TODO: Resolve and fix the `self.outputs` in the reinforcement
TODO: Supervisor should not be for every connection, they effect dopamine!
TODO: Different Metrics must also be excluded or combine their reports!

TODO: For population we don't need winner take all, need activity measuring instead
TODO: For population we don't need supervisor for activity
TODO: Remove delay learning for the (pos|neg) synapse connections
TODO: Add weights initializer with J0/N strategies
TODO: What does max_word_delay means in the words:pos connection
TODO: ActivitySupervisor needs to know how other pop behave or not?
TODO: Now all words are selected but we might need to trim them in `word_length_threshold`
TODO: In neuron morphology `tau` -> max(words_spacing_gap, maximum_length_words), max_length is different from what it should be
...
FIXME: max instead of clip and slice instead of roll
"""
...
def network():
    ...
    common_words = extract_words(train_df, word_length_threshold=17)
    ...
    pop_ng_behaviours = {
        ...
        5: PopulationBaseActivity(),
        6: PopulationBaseHomeostasis(**homeostasis_base),
    }
    ...
    balanced_network_args = {"J0": 20, "P": 0.7}
